...
public class InternalBusTabel extends JPanel {
    /**
	 * 
	 */
    ...
    public InternalBusTabel() {
        super(new GridLayout(1,0));

        String[] columnNames={"BusType","DriverName","BusColour","Maximum Passengers"};
        Object[][] data = {
        		 {"Internal Bus", "Michelle Robert", //$NON-NLS-1$ //$NON-NLS-2$
                     "White", new Integer(50)}, //$NON-NLS-1$
                    {"Internal Bus", "Joshua Watson", //$NON-NLS-1$ //$NON-NLS-2$
                     "Yellow", new Integer(34)}, //$NON-NLS-1$
